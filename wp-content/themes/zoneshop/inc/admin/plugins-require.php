...
function tp_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'             => 'http://downloads.wordpress.org/plugin/mailchimp-for-wp.2.2.8.zip', // The plugin source
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.2.0.5.zip', // The plugin source
