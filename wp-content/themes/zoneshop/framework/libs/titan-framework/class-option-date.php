	...
	class TitanFrameworkOptionDateControl extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<label class='tf-date'>
				...
				<input class="input-date<?php echo esc_attr($class) ?>" <?php ent2ncr($this->link()); ?> placeholder="<?php echo esc_html($placeholder) ?>" type="text" value="<?php echo esc_html($this->value()) ?>" />
